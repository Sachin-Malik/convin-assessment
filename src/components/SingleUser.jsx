  ...
  return (
    <div>
      ...
      <div className='row justify-content-around mb-5'>
         <div className='col-md-3 col-12 card shadow rounded p-3 user'>
            <img src={data.avatar} alt='Profile Pic for User' />
         </div>
         <div className='col-md-8 col-12 text-left p-5 card shadow rounded p-3 user-detail user-card-dashboard'>
